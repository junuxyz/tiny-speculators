...
from tiny_speculators.config import Config, QWEN3_8B_CONFIG_DEFAULTS
...
def default_qwen3_8b_config() -> Qwen3Config:
    ...
    return Qwen3Config(
        **QWEN3_8B_CONFIG_DEFAULTS,
        num_hidden_layers=Config.verifier_num_hidden_layers,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if transformer_layer_config is None:
            ...
            transformer_layer_config = copy.deepcopy(
                transformer_layer_config
            )  # independent config for draft
